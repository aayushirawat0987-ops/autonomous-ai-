...
export function getWriterPrompt(
  ...
  let structureInstruction = `1. HOOK (20–40 words): Specific opening about "${topic.title}".
...
5. KEY TAKEAWAY (20–40 words): Meaningful concluding insight on ${topic.title}.`;
...
- Do NOT generate generic placeholder sentences ("recent disclosures regarding...", "as technology systems evolve across..."). Provide 3+ topic-specific facts.

POST-TYPE & CONTENT ANGLE CONTROL:
If the angle is "Common Misconception", identify a REAL misconception about "${topic.title}" and correct it with verified facts. Do not generate generic software engineering content.
